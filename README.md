...
Amaç, düşük maliyetli bir donanım ile ortam sıcaklık ve nem değerlerini anlık olarak izleyebilen, mobil cihazlar üzerinden erişilebilir bir sistem geliştirmektir. Bu proje, IoT (Internet of Things) ve mobil uygulama entegrasyonuna pratik bir örnek sunar.
